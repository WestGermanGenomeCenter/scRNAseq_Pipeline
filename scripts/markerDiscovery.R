...
write.csv(GE.215.integrated.markers, file=paste(projectDirPath, "csv/", project,".integrated.markers.csv", sep=""))
GE.215.integrated.avgExpression <- AverageExpression(GE.215.integrated,assays = "RNA")
write.csv(GE.215.integrated.avgExpression, file=paste(projectDirPath, "csv/", project, ".integrated.avgExpression.csv", sep=""))
